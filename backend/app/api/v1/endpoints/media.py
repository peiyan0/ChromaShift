    ...
    try:
        ...
        try:
            ...
            if job:
                ...
                # Save PDF specific metrics if available
                if media_type == "pdf" and hasattr(processor, 'last_pdf_metrics'):
                    job.pdf_page_count = processor.last_pdf_metrics.get("page_count")
                    job.pdf_vector_complexity = processor.last_pdf_metrics.get("vector_complexity")
